...
class Trainer(object):
    def __init__(self,
        ...
        if cfg.get('resume_model', None):
            ...
            self.logger.info(
                "Loading Checkpoint... Best Result:{}, Best Epoch:{}".format(self.best_result, self.best_epoch))
    ...
    def train_one_epoch(self, epoch):
        ...
        progress_bar = tqdm.tqdm(total=len(self.train_loader), leave=(self.epoch + 1 == self.cfg['max_epoch']),
                                 desc='iters')
